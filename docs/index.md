...
# Application
An application built from https://github.com/jdubrick-ai/quarkus-rhdh-1 will be stored in [quay.io/jdubrick-ai/quarkus-rhdh-1](https://quay.io/jdubrick-ai/quarkus-rhdh-1) and deployed through GitOps. This application is accessible on port **8080**.